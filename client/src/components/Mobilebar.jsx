...
const MobileBar = () => {
  return (
    <div id="mobile-bottom-bar" className="fixed lg:hidden bottom-3 left-3  right-3 py-3 px-1 m-auto shadow-md bg-muted rounded-full flex justify-center max-w-[700px]">
